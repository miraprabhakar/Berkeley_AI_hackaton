...
export class Client implements AnyClient {
  ...
  */
   ...
   */
  apiRoots: Record<string, string> = {"development":"https://songatron--development.gadget.app/","production":"https://songatron.gadget.app/"};
