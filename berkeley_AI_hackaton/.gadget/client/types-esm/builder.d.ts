import type { ActionFunctionMetadata, AnyModelFinderMetadata, AnyModelManager, FieldSelection, GadgetConnection, VariablesOptions } from "@gadgetinc/api-client-core";
/**
 ...
 **/
export declare const buildModelManager: (apiIdentifier: string, pluralApiIdentifier: string, defaultSelection: FieldSelection, operationGroup: ModelManagerOperation[] | readonly ModelManagerOperation[]) => {
    new (connection: GadgetConnection): AnyModelManager;
    prototype: AnyModelManager;
};
export declare const buildGlobalAction: (client: {
    connection: GadgetConnection;
}, operation: GlobalActionOperation | StubbedActionOperation) => (((..._args: any[]) => never) & StubbedActionOperation) | (((variables?: Record<string, any>) => Promise<any>) & GlobalActionOperation);
