...
exports.actionContextLocalStorage = exports.Globals = exports.connections = exports.logger = exports.api = exports.setApiClient = exports.setLogger = exports.setConnections = exports.InvalidStateTransitionError = exports.DefaultEmailTemplates = void 0;
...
const setConnections = (appConnections) => {
    exports.connections = connections = new Proxy(appConnections, {
        get: (target, prop) => {
            const actionContext = globals_1.actionContextLocalStorage.getStore();
            if (actionContext && actionContext.connections) {
                return actionContext.connections[prop];
            }
            const routeContext = globals_1.Globals.requestContext.get("requestContext");
