...
declare module "fastify" {
  interface FastifyRequest {
    ...
    /** All songatron configuration values */
    config: AppConfiguration;

    /** A map of connection name to instantiated connection objects for songatron */
    ...
    /**
     * An instance of the API client for songatron.
     *
